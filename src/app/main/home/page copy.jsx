                    ...
                    <div className="w-full rounded-2xl p-4 bg-white h-72">
                        <div className="flex flex-col gap-1 h-full">
                            ...
                            <div className="w-full h-3/12">
                                <div className="grid gap-2 h-full space-y-0  grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="w-full hidden md:block bg-base-300 rounded-md h-3/12">
                                <p>TBA</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            Shopping
                                            <br />
                                            <span className="hidden xl:inline badge badge-ghost badge-sm">15 Mins Ago</span>
                                        </td>
                                        <td>+ Rp 50.000.000</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            Tax
                                            <br />
                                            <span className="hidden xl:inline badge badge-ghost badge-sm">10 Mins Ago</span>
                                        </td>
                                        <td>- Rp 50.000.000</td>
                                    </tr>
                                    <tr>
            ...
            <dialog id="my_modal_1" className="modal">
                <div className="modal-box">
                    ...
                    <div className="flex flex-col space-y-3 w-full">
                        ...
                        <select ref={transactionTypeRef} onChange={handleChangeType} className="w-full select" name="" id="">
